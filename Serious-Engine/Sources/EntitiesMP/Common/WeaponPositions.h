...
wpn_fY[30]=(FLOAT)0;
wpn_fZ[0]=(FLOAT)0;
wpn_fZ[1]=(FLOAT)-0.7; //knife
wpn_fZ[2]=(FLOAT)-0.26; //colt
wpn_fZ[3]=(FLOAT)-0.26; //2 colts
wpn_fZ[4]=(FLOAT)-0.5; //single shotgun
wpn_fZ[5]=(FLOAT)-0.5; //double shotgun
wpn_fZ[6]=(FLOAT)-0.4; //tommygun
wpn_fZ[7]=(FLOAT)-0.4; //minigun
wpn_fZ[8]=(FLOAT)-0.26; //rocket launcher
wpn_fZ[9]=(FLOAT)-0.4; //grenade launcher
wpn_fZ[10]=(FLOAT)-0.5; //chainsaw
wpn_fZ[11]=(FLOAT)-0.65; //flamer
wpn_fZ[12]=(FLOAT)-0.175; //laser
wpn_fZ[13]=(FLOAT)-0.85; //sniper
wpn_fZ[14]=(FLOAT)-0.7; //iron cannon
wpn_fZ[15]=(FLOAT)0;
