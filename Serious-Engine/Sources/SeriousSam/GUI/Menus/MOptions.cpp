...
void COptionsMenu::Initialize_t(void)
{
  ...
  gm_mgVideoOptions.mg_pmgUp = &gm_mgCustomOptions;
  gm_mgVideoOptions.mg_pmgDown = &gm_mgAddonOptions;
  gm_mgVideoOptions.mg_strText = TRANS("ANDROID PORT SETTINGS");
  gm_mgVideoOptions.mg_strTip = TRANS("Screen size, gyroscope and more");
  ...
  gm_mgAddonOptions.mg_boxOnScreen = BoxBigRow(1.1f);
  gm_mgAddonOptions.mg_pmgUp = &gm_mgVideoOptions;
  gm_mgAddonOptions.mg_pmgDown = &gm_mgAudioOptions;
  gm_mgAddonOptions.mg_strText = TRANS("RENDERING OPTIONS");
  gm_mgAddonOptions.mg_strTip = TRANS("manually adjust rendering settings");
  ...
  gm_mgAudioOptions.mg_boxOnScreen = BoxBigRow(2.1f);
  gm_mgAudioOptions.mg_pmgUp = &gm_mgAddonOptions;
  ...
  gm_mgPlayerProfileOptions.mg_bEnabled = true;
